...
int main(){
	...
	for(int i = 0; i < NumOfFiles; i++){
		...
		for(int c = Ti_zone-1; c < NumOfZones; c++){
			...
			if(Rcond1 && Rcond2){
				outputfile1<<setw(2)<<(c+1)<<setprecision(17)<<setw(25)<<Ci[c]<<setw(25)<<Vd[c]<<setw(25)<<Vr[c]<<setw(10)<<Rcond1<<setw(10)<<Rcond2<<setw(10)<<Dcond1<<setw(10)<<Dcond2<<setw(10)<<"R"<<endl;
			}
			if(Dcond1 && Dcond2){
				outputfile1<<setw(2)<<(c+1)<<setprecision(17)<<setw(25)<<Ci[c]<<setw(25)<<Vd[c]<<setw(25)<<Vr[c]<<setw(10)<<Rcond1<<setw(10)<<Rcond2<<setw(10)<<Dcond1<<setw(10)<<Dcond2<<setw(10)<<"D"<<endl;
			}
			if(!(Rcond1 && Rcond2) && !(Dcond1 && Dcond2)){
				outputfile1<<setw(2)<<(c+1)<<setprecision(17)<<setw(25)<<Ci[c]<<setw(25)<<Vd[c]<<setw(25)<<Vr[c]<<setw(10)<<Rcond1<<setw(10)<<Rcond2<<setw(10)<<Dcond1<<setw(10)<<Dcond2<<setw(10)<<"Could not be found"<<endl;
			}
